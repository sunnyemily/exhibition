...
<div class="mem-box" style="margin:10px auto">
	...
	<div class="mem-right">
		...
		<div class="mem-meglist">
			<ul>
			<#list xpinfos as xpinfo>
				<li>
					<a href="javascript:void(0)" onclick="showmessage(${xpinfo.id})">· 【${xpinfo.menuname}】${xpinfo.title}</a>
					<span>${xpinfo.addtime}</span>
					<div id="neirong${xpinfo.id}">
						<table border=1 class="layui-table" width="90%">
							<tr>
								<td align="center" width="200px" align="center">产品类别:</td><td>${xpinfo.menuname}</td>
							</tr>
							<tr>
								<td align="center">标题:</td><td>${xpinfo.title}</td>
							</tr>
							<tr style="display:none">
								<td align="center">联系人:</td><td>${xpinfo.name}</td>
							</tr>
							<tr>
								<td align="center">联系方式:</td><td>${xpinfo.tel}</td>
							</tr>
							<tr>
								<td align="center">数量:</td><td>${xpinfo.quantity}${xpinfo.quantityunitname}</td>
							</tr>
							<tr>
								<td align="center">内容:</td><td>${xpinfo.content}</td>
							</tr>
							<tr>
								<td align="center">审核状态:</td><td>${xpinfo.statusname}</td>
							</tr>
							<tr>
								<td align="center">审核内容:</td><td style="color:red">${xpinfo.remark}</td>
							</tr>
							<tr>
								<td align="center">发布的时间:</td><td>${xpinfo.addtime}</td>
							</tr>
						</table>
					</div>
				</li>
			...
			<div class="pages">
				<#list paging as page>
					<a ${(page.yema == pageIndex)?string('class="active"','')} ${(page.yema == 0)?string('','href="inquiry-'+page.yema+'.html"')}>${page.title}</a>
				</#list>
			</div>
		</div>
	</div>
