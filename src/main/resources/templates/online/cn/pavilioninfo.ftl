...
<div class="show-bodybg">
	<div class="box">
		<div class="zb-top">
			...
			<#if flink.videourl=="" && flink.friendlinkPicture2=="">
				<img src="${flink.friendlinkPicture}" width="100%" height="570px">								
			<#else>
...
<script>
	...
	<#if flink.videourl!="" && flink.friendlinkPicture2!="">
			var player =  new TcPlayer('video', {
				...
				"autoplay" : true,
				"poster" : "${flink.friendlinkPicture}",
				"width" :  '100%',
				"height" : '100%'
			});				
		</#if>
