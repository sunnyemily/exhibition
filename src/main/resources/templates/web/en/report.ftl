...
<head>
<title>card collection form</title>
...
<div class="main print-main">
	...
	<form name="form1" method="post" class="layui-form">
			...
			<div class="layui-input-inline"><select id="cards"  lay-filter="cards">
				<option  selected="selected" value="0">personnel card</option>
				<option value="1">vehicle card</option>
			</select></div>
			...
			<div class="layui-input-inline"> 
			<input type="radio" name="status" value="0" title="not collected" checked />
			<input type="radio" name="status" value="1" title="collected" />
			<input type="radio" name="status" value="-1" title="all" /></div>
			<button type="button" class="layui-btn layui-btn-primary" onclick="load()"><i class="layui-icon">&#xe615;</i> search</button >
			<button type="button" onclick="pt();" class="layui-btn layui-btn-primary"><i class="fa fa-print"></i> print</button>
	</form>
	<hr>
				...
				<tbody>
					...
					<tr>
						<td colspan="2"
							...
							id="DBDaibanOtherPrintZJLX1">card type</span>:</td>
						<td class="col" colspan="6"
							style="font-size: 18px; text-align: left; font-weight: bold;"><span
							id="exhibTypeName">exhibitor card B</span></td>

					</tr>
					<tr>
						<td colspan="2"
							style="font-size: 18px; text-align: right; font-weight: bold;"><span
							id="companys">company name</span>:</td>
						<td class="col" colspan="6"
							style="font-size: 18px; text-align: left; font-weight: bold;"><span
				...
				<tbody id="personHead">
					<tr align="center" style="height: 28px; font-size: 16px;">
						<td class="th_left1" style="font-weight: bold;"><span
							id="Label3">index</span></td>
						<td class="th_left2" style="font-weight: bold;"><span
							id="Label4">name</span></td>
						<td class="th_left2" style="font-weight: bold;"><span
							id="Label5">gender</span></td>
						<td class="th_left2" style="font-weight: bold;" colspan="2"><span
							id="DBDaibanOtherPrintQY">name</span></td>
						<td class="th_left2" style="font-weight: bold;"><span
							id="DBDaibanOtherPrintZJLX">card type</span></td>
						<td class="th_left2 boothname" style="font-weight: bold;display:none" colspan="2"><span
							id="DBDaibanOtherPrintZWH">booth number</span></td>
					</tr>
				</tbody>
				<tbody id="personBody">
				</tbody>
				<tbody id="carHead" style="display:none">
					<tr align="center" style="height: 28px; font-size: 16px;">
						...
						<td class="th_left2" colspan="2" style="font-weight: bold;"><span
							id="Label4">company name/span></td>
						<td class="th_left2" style="font-weight: bold;"><span
							id="Label5">license plate number</span></td>
						<td class="th_left2" style="font-weight: bold;" colspan="4"><span>driver name</span></td>
					</tr>
				</tbody>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="1" style="font-size: 16px; text-align: left;"><span
							id="Label7">stamp</span></td>
					</tr>
					<tr>
						<td colspan="6" class="col" style="font-size: 16px; height: 50px;"></td>
						<td colspan="1" style="font-size: 16px; text-align: left;"><span
							id="Label8">sign</span>:</td>
					</tr>
					<tr>
						<td colspan="6" class="col" style="font-size: 16px; height: 50px;"></td>
						<td colspan="1" style="font-size: 16px; text-align: left;"><span
							id="DBDaibanOtherPrintRQ">date</span>:${.now?string("yyyy年MM月dd日")}</td>
					</tr>
				</tbody>
			</table>
		</div>
...
<script>
var noPermission ="there is no authority to handle such cards";
var inSearch='querying';
var exhibitionCard="exhibitor card";
</script> 
