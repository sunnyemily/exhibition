...
import cn.org.chtf.card.manage.Decorators.dao.DecoratorEbsVehiclecardMapper;
 ...
 */
@Service
public class DecoratorEbsVehiclecardServiceImpl implements DecoratorEbsVehiclecardService {

    @Autowired
    private DecoratorEbsVehiclecardMapper decoratorEbsVehiclecardMapper;
    ...
    public PageInfo<EbsVehiclecard> page(RequestParamsUtil requestParamsUtil) {
        ...
        return new PageInfo<>(decoratorEbsVehiclecardMapper.list(requestParamsUtil.getParameters()));
    }
    ...
    public List<EbsVehiclecard> list(Map<String, Object> map) {
        return decoratorEbsVehiclecardMapper.list(map);
    }
    ...
    public int listcount(Map<String, Object> map) {
        return decoratorEbsVehiclecardMapper.listcount(map);
    }
    ...
    public EbsVehiclecard findById(Integer id) {
        return decoratorEbsVehiclecardMapper.findById(id);
    }
    ...
    public List<EbsVehiclecard> findByMap(Map<String, Object> map) {
        return decoratorEbsVehiclecardMapper.findByMap(map);
    }
    ...
    public int save(EbsVehiclecard ebsVehiclecard) {
        return decoratorEbsVehiclecardMapper.save(ebsVehiclecard);
    }
    ...
    public int update(EbsVehiclecard ebsVehiclecard) {
        return decoratorEbsVehiclecardMapper.update(ebsVehiclecard);
    }
    ...
    public int deleteById(Integer id) {
        return decoratorEbsVehiclecardMapper.deleteById(id);
    }
    ...
    public ResultModel getVehicleCards(EbsVehiclecard vehiclecard, PageModel page) {
        ...
        try {
            ...
            result.setResult(decoratorEbsVehiclecardMapper.list(map));
            ;
            result.setCount(decoratorEbsVehiclecardMapper.listcount(map));
        } catch (Exception e) {
    ...
    public ResultModel delete(Integer[] ids, Integer memberId) {
        ...
        try {
            for (int id : ids) {
                decoratorEbsVehiclecardMapper.deleteByIdAndMemberId(id, memberId);
            }
    ...
    public ResultModel takeAwayReport(Integer delay, Integer memberId, Integer sessionId, Integer awayStatus, Integer cardType) {
        ...
        try {
            ...
            if (awayStatus == 0) {
                decoratorEbsVehiclecardMapper.updatePrintNumber(printNumber, memberId, makecardtime, sessionId, awayStatus, cardType);
            }
            List<Map<String, Object>> list = decoratorEbsVehiclecardMapper.takeAwayReport(memberId, makecardtime, sessionId, awayStatus, cardType);
    ...
    public int updatePrintNumberByMap(Map<String, Object> map) {
        return decoratorEbsVehiclecardMapper.updatePrintNumberByMap(map);
    }

    @Override
    public void deleteByMap(Map<String, Object> map) {
        decoratorEbsVehiclecardMapper.deleteByMap(map);
    }
    ...
    public ResultModel getHistoryCarCard(Integer memberId, Integer sessionId, String cardname, PageModel page) {
        ...
        try {
            result = new ResultModel(WConst.SUCCESS, WConst.QUERYSUCCESS, null);
            result.setResult(decoratorEbsVehiclecardMapper.getHistoryCarCard(map));
            ;
            result.setCount(decoratorEbsVehiclecardMapper.getHistoryCarCardCount(map));
        } catch (Exception e) {
            result = new ResultModel(WConst.ERROR, WConst.QUERYFAILD, e.getMessage());
        }
    ...
    public ResultModel rejoin(Integer[] idList, int exhibitionSessionId, int memberId) {
        ...
        try {
            for (int i = 0; i < idList.length; i++) {
                id = idList[i];
                EbsVehiclecard carCard = decoratorEbsVehiclecardMapper.findById(id);
                //获取当前届次的证件类型
                ...
                List<EbsVehiclecard> cards = decoratorEbsVehiclecardMapper.findByMap(filter);
                if (cards.size() > 0) {
                    ...
                    decoratorEbsVehiclecardMapper.save(carCard);
                }
    ...
    public List<Map<String, Object>> VehicleIDMarkList(Map<String, Object> map) {
        return decoratorEbsVehiclecardMapper.VehicleIDMarkList(map);
    }

    @Override
    public int VehicleIDMarkListCount(Map<String, Object> map) {
        return decoratorEbsVehiclecardMapper.VehicleIDMarkListCount(map);
    }

    @Override
    public Map<String, Object> loadCount(Map<String, Object> map) {
        return decoratorEbsVehiclecardMapper.loadCount(map);
    }
