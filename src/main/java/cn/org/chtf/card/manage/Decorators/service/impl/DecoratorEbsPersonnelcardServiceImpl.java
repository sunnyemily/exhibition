...
import cn.org.chtf.card.manage.Decorators.dao.DecoratorEbsPersonnelcardMapper;
 ...
 */
@Service
public class DecoratorEbsPersonnelcardServiceImpl implements DecoratorEbsPersonnelcardService {

    @Autowired
    private DecoratorEbsPersonnelcardMapper decoratorEbsPersonnelcardDao;
    ...
    public List<EbsPersonnelcard> list(Map<String, Object> map) {
        ...
        List<EbsPersonnelcard> list = decoratorEbsPersonnelcardDao.list(map);
    ...
    public int listcount(Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.listcount(map);
    }
    ...
    public EbsPersonnelcard findById(Integer id) {
        EbsPersonnelcard epc = decoratorEbsPersonnelcardDao.findById(id);
    ...
    public List<EbsPersonnelcard> findByMap(Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.findByMap(map);
    }
    ...
    public int save(EbsPersonnelcard ebsPersonnelcard) {
        return decoratorEbsPersonnelcardDao.save(ebsPersonnelcard);
    }
    ...
    public int update(EbsPersonnelcard ebsPersonnelcard) {
        return decoratorEbsPersonnelcardDao.update(ebsPersonnelcard);
    }
    ...
    public int deleteById(Integer id) {
        return decoratorEbsPersonnelcardDao.deleteById(id);
    }
    ...
    public List<EbsPersonnelcard> listFront(Map<String, Object> map) {
        ...
        return decoratorEbsPersonnelcardDao.list(filter);
    }
     ...
     */
    @Override
    public int listFrontCount(Map<String, Object> map) {
        Integer statuCode = (Integer) map.get("status");
        ...
        filter.put("agent", map.get("memeberId"));
        return decoratorEbsPersonnelcardDao.listcount(filter);
    }

    @Override
    public List<Map<String, Object>> GetDownLoadInfo(Map<String, Object> map) {
        List<Map<String, Object>> list = decoratorEbsPersonnelcardDao.GetDownLoadInfo(map);
    ...
    public ResultModel getPersonCards(EbsPersonnelcard personCard, PageModel page) {
        ...
        try {
            ...
            result.setResult(decoratorEbsPersonnelcardDao.list(map));
            ;
            result.setCount(decoratorEbsPersonnelcardDao.listcount(map));
        } catch (Exception e) {
    ...
    public ResultModel delete(Integer[] ids, Integer memberId) {
        ...
        try {
            ...
            int row = decoratorEbsPersonnelcardDao.delete(idList, memberId);
    ...
    public List<EbsPersonnelcard> ExhibitorBadgeProductionlist(
        ...
        List<EbsPersonnelcard> list = decoratorEbsPersonnelcardDao.ExhibitorBadgeProductionlist(map);
		/*
    	List<Map<String,Object>> dbys = commonDao.getDBYName(map);
    	for(int j=0;j<list.size();j++){   	
    		int iagentid = list.get(j).getAgent();
    ...
    public int ExhibitorBadgeProductionlistcount(Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.ExhibitorBadgeProductionlistcount(map);
    }
    ...
    public ResultModel getHistoryPersonCard(Integer memberId, Integer sessionId, String cardname, PageModel page) {
        ...
        try {
            result = new ResultModel(WConst.SUCCESS, WConst.QUERYSUCCESS, null);
            result.setResult(decoratorEbsPersonnelcardDao.getHistoryPersonCard(map));
            ;
            result.setCount(decoratorEbsPersonnelcardDao.getHistoryPersonCardCount(map));
        } catch (Exception e) {
            result = new ResultModel(WConst.ERROR, WConst.QUERYFAILD, e.getMessage());
        }
    ...
    public ResultModel rejoin(Integer[] idList, Integer repeat, Map<String, Object> exhibitionInfo, Member member) {
        ...
        try {
            for (int i = 0; i < idList.length; i++) {
                id = idList[i];
                //获取以前届次的证件
                EbsPersonnelcard personCard = decoratorEbsPersonnelcardDao.findById(id);
                //获取当前届次的证件类型
...
//				}
                ...
                List<EbsPersonnelcard> cards = decoratorEbsPersonnelcardDao.findByMap(filter);
                if (cards.size() > 0 && repeat.equals(0)) {
                    ...
                    decoratorEbsPersonnelcardDao.save(personCard);
                }
    ...
    public boolean isExceedLimit(CmCertificateType card, EbsPersonnelcard ebsPersonnelcard, Member member, Map<String, Object> exhibitionInfo) {
        ...
        //3.获取已填报此类证件的总数
        int addCount = decoratorEbsPersonnelcardDao.addCount(card.getId(), sessionId, member.getMemberId(), ebsPersonnelcard.getId());
    ...
    public ResultModel takeAwayReport(Integer delay, Integer memberId, Integer sessionId, Integer awayStatus, Integer cardType) {
        ...
        try {
            ...
            if (awayStatus == 0) {
                decoratorEbsPersonnelcardDao.updatePrintNumber(printNumber, memberId, makecardtime, sessionId, awayStatus, cardType);
            }
            List<Map<String, Object>> list = decoratorEbsPersonnelcardDao.takeAwayReport(memberId, makecardtime, sessionId, awayStatus, cardType);
    ...
    public void deleteByMap(Map<String, Object> par) {
        decoratorEbsPersonnelcardDao.deleteByMap(par);
    }

    @Override
    public List<EbsPersonnelcard> Greenlist(Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.Greenlist(map);
    }

    @Override
    public int Greenlistcount(Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.Greenlistcount(map);
    }

    @Override
    public List<Map<String, Object>> PersonnelCardQuerylist(Map<String, Object> map) {
        List<Map<String, Object>> list = decoratorEbsPersonnelcardDao.PersonnelCardQuerylist(map);
        List<Map<String, Object>> dbys = commonDao.getDBYName(map);
        for (int j = 0; j < list.size(); j++) {
    ...
    public int PersonnelCardQuerylistcount(Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.PersonnelCardQuerylistcount(map);
    }

    @Override
    public List<Map<String, Object>> PersonnelCertificateCollectionList(Map<String, Object> map) {
        List<Map<String, Object>> list = decoratorEbsPersonnelcardDao.PersonnelCertificateCollectionList(map);
        return list;
    }

    @Override
    public int PersonnelCertificateCollectionListCount(Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.PersonnelCertificateCollectionListCount(map);
    }
    ...
    public ResultModel updateRouterPersonRole(String cardnumber, String name, Integer sessionId, HttpSession session) {
        try {
            ...
            //3.获取添加证件的人的所属公司类型
            EbsCompanyinfo company = decoratorEbsPersonnelcardDao.getRouterPersonRole(cardnumber, name, sessionId);
            if (company == null ||
    ...
    public ResultModel getRouterPersonRole(Integer sessionId, HttpSession session) {
        try {
            ...
            if (user.getUserTypeId().equals(0)) {
                ...
                EbsCompanyinfo company = decoratorEbsPersonnelcardDao.getRouterPersonRole(user.getCardnumber(), user.getName(), sessionId);
    ...
    public List<Map<String, Object>> getPersonnelCardList(
            Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.getPersonnelCardList(map);
    }

    @Override
    public int getPersonnelCardListCount(Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.getPersonnelCardListCount(map);
    }

    @Override
    public int resetStatusByCompanyId(Map<String, Object> map) {
        return decoratorEbsPersonnelcardDao.resetStatusByCompanyId(map);
    }
